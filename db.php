...
class db {
	...
	function __construct($params=array()) {
		$this->conn = false;
		$this->host = 'efs-dbinstance.cvitqrmmfm0c.us-west-2.rds.amazonaws.com'; //hostname
		$this->user = 'EFSuser123'; //username
		$this->password = 'hello1234'; //password
		$this->baseName = 'EFSDB'; //name of your database
		$this->port = '3306';
		$this->debug = true;
		$this->connect();
	}
